            ...
            <div className='pop'>
                ...
                {createProduct.loading ?
                    ...
                    <div className='popupBody'>
                        ...
                        <TextField error={error.price != ''} label="سعر" type='number' variant="filled" sx={{ width: '31%' }} value={details?.price} onChange={(e) => setDetails({ ...details, price: e.target.value })} />
                        <TextField error={error.discount != ''} label="خصم النسبة المئوية" type='number' variant="filled" sx={{ width: '31%' }} value={details?.discount} onChange={(e) => setDetails({ ...details, discount: e.target.value })} />
                        ...
                        {details.platform && <div className='catsAndSubcats'>
                            <FormControl error={error.brand != ''} variant="filled" sx={{ width: '81%' }} >
                                ...
                                <Select label="ماركة" value={details?.brand} onChange={(e) => setDetails({ ...details, brand: e.target.value })}  >
                        ...
                        <Button onClick={() => CreateProduct()} variant='contained' className='createButon'>يخلق</Button>
                    </div>
                }
            </div>
        </div>
